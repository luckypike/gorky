      ...
      <div className={styles.page}>
        ...
        <CommonText>
          <p>
            ...
            сборке самолетных радиостанций, сборке и монтажу узлов радиостанций.
            После начала войны был организован цех по выпуску сопротивлений и
            конденсаторов, участок по переделке стрелочных измерительных
            приборов. К октябрю того же года сюда с завода № 203 было передано
            производство приемников УС со всем оборудованием, документацией и
            аппаратурой.
          </p>
