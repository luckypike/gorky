    ...
    <div className={styles.root}>
      <div className={styles.page}>
        ...
        <CommonImage content>
          <figure className={classNames(styles.img, styles.main)}>
            ...
            <figcaption>
              Немецкая аэрофотосъемка Горького. Начальник службы маскировки ГАЗа
              Н. В. Безребрый : «Типичная для социалистических промпредприятий
              компоновка генплана, наличие вокруг завода хороших ориентиров —
              все эти особенности делают задачу технической маскировки объекта
              чрезвычайно трудной»
            </figcaption>
          </figure>
        </CommonImage>
        ...
        >
          ...
          Горького и стоящего на передовой его линии автозавода явно неправильна
          и ни в коей мере не отвечает важности этого сектора. Итоги всех
          налетов показали, что враг в первую очередь старается поразить
          автозавод, который, в отличие от других заводов, имеет огромную
          отдельно расположенную территорию, прекрасные ориентиры на подступах к
          нему. Заводы, стоящие в глубине районов Горького, как правило,
          прикрываются полком, а автозавод, несмотря на важность его и по
          существу прикрывающий зенитными средствами эти заводы с юго-западного
      ...
      <div className={styles.images}>
        ...
        <figure className={classNames(styles.img, styles._3)}>
          ...
          <figcaption>
            На предприятии вели сводку авианалетов и составляли подробный отчет
            об упавших бомбах
          </figcaption>
        </figure>
      </div>
      ...
      <div className={styles.page}>
        ...
        >
          «4 ноября 1941 года средь бела дня низко пролетели самолеты с черными
          крестами: над людьми в очередях, над заводскими проходными. В 16 часов
          30 минут начались обстрел и бомбежка улиц, домов и завода. Беженцев из
          Москвы расселили в Автозаводском районе. Они жили в бараках около
          гостиницы. В ту бомбежку один их барак сгорел вместе с людьми, другой
          был разрушен. У шестой проходной ГАЗа бомба попала в автобус с людьми.
          Погибших женщин, детей, стариков схоронили в групповой могиле в
          лесопитомнике (сегодня это монумент Славы с Вечным огнем — ред.). 4
          ноября было убито 55 человек, ранено 141».
        </Speech>
      </div>
    </div>
  )
