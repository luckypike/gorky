    ...
    <div className={styles.root}>
      <div className={styles.page}>
        ...
        <Columns
          ...
          right={
            <div>
              Андрей Александрович Липгарт (1898–1980)
              <br />
              Родился в Москве в семье служащего немецкого происхождения.
              Окончил Императорское Московское техническое училище (ныне МГТУ им. Баумана). Начал карьеру в Центральном научно-исследовательском автомобильном
              и автомоторном институте (НАМИ). В 1933 году был назначен главным конструктором Горьковского автозавода. С 1952 года работал на Уральском автозаводе.
              В 1953 году вернулся в НАМИ в качестве главного конструктора. До 1973 года руководил кафедрой «Колесные машины» в МГТУ.
              В 1960 году ему присвоена степень доктора технических наук Honoris causa — по совокупности достижений. Награжден тремя орденами Ленина,
