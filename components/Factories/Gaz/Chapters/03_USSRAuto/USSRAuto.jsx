  ...
  return (
    <div className={styles.root}>
      <div className={styles.page}>
        <MainText title="Гигант советского автопрома ">
          <p>
            ...
            контракт с СССР был выгодным предложением для американской компании.
          </p>
        </MainText>
      </div>
      ...
      <div className={styles.page}>
        <CommonText>
          <p>
            В 1929 году началась работа над первыми проектами — легковыми
            машинами ГАЗ-А и грузовиками ГАЗ-АА, прототипами которых были Ford-A
            и Ford-AA Согласно договору с Ford Motor Company, ГАЗ обязался
