      ...
      <div className={styles.page}>
        <MainImage>
          <figure className={classNames(styles.img, styles.intro)}>
            ...
            <figcaption>Завод пустили в строй 1 января 1932 года</figcaption>
          </figure>
        </MainImage>
      </div>
      ...
      <div className={styles.page}>
        ...
        <CommonImages>
          <figure className={classNames(styles.img, styles._1)}>
            ...
            <figcaption>
              Проектированием заводских корпусов занималась американская
              компания Austin
            </figcaption>
          </figure>
          ...
          <figure className={classNames(styles.img, styles._2)}>
            ...
            <figcaption>
              Крепкие плечи да мозолистые руки — вот и вся механизация
            </figcaption>
          </figure>
        </CommonImages>
        ...
        <CommonText>
          <p>
            Согласно договору с Ford Motor Company, ГАЗ обязался закупить у
            американской компании 72 тыс. комплектов деталей для сборки машин.
            На Горьковском автозаводе планировали самостоятельно изготовлять
            примерно до 60% наименований узлов и деталей для сборки машин, а
            остальные компоненты закупать на стороне. Проектированием цехов и
            корпусов занималась американская компания Austin. Завод, который
            сначала назывался нижегородским, а затем получил имя одного из
            руководителей советского государства Вячеслава Молотова, пустили в
            строй 1 января 1932 года. В 1935 году по обоюдному согласию договор
            с Ford Motor Company был расторгнут. В тот же год с конвейера завода
          ...
          <p className={styles.vrezka}>
            Первая модель ГАЗа, легендарная «полуторка» ГАЗ-АА, сыграла
            важнейшую роль в поддержании связи блокадного Ленинграда с внешним
            миром
          </p>
        </CommonText>
      </div>
