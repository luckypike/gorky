      ...
      <div className={styles.page}>
          ...
          right={(
            <div>
              <p>
                ...
                штамповка…». Токарь Шалунов дал производственный рекорд — 2000 процентов нормы».
              </p>
            </div>
          )}
        />
        ...
        <CommonImage content>
          <figure className={classNames(styles.img, styles._1)}>
            ...
            <figcaption>
              Становлением завода № 467 руководил А. Ф. Авербах (в центре), до этого работавший на заводе № 21 в Горьком и туда же вернувшийся после войны
            </figcaption>
          </figure>
        </CommonImage>
