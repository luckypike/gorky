      ...
      <div className={styles.page}>
        <MainText title="Женщины встали к станкам">
          <p>
            ...
            Молодые мужчины ушли на фронт, их место заняли ветераны труда,
            которые успели уйти на заслуженный покой. «Мы, старики, не должны
            сидеть дома. В грозный и ответственный момент у нас еще хватит сил
            по-боевому работать для своей Родины»,— обратился к коллегам ветеран
            труда И. М. Олимпиев. В первый же год на завод вернулись более
            тысячи ветеранов. К станкам вставали и женщины, бывшие прежде
            домохозяйками, и подростки. Они работали крановщицами,
        ...
        <CommonImage>
          <figure className={classNames(styles.img, styles.main)}>
            ...
            <figcaption>
              Женщины работали крановщицами, пультовщицами, токарями
            </figcaption>
          </figure>
        </CommonImage>
        ...
        <CommonImage content>
          <figure className={classNames(styles.img, styles._1)}>
            ...
            <figcaption>
              Лучшим фронтовым бригадам вручали знамя и денежные премии
            </figcaption>
          </figure>
        </CommonImage>
        ...
        <div className={styles.images}>
          <figure className={classNames(styles.img, styles._3)}>
            ...
            <figcaption>Центральная химическая лаборатория завода</figcaption>
          </figure>
