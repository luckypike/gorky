      ...
      <div className={styles.page}>
        <MainText title="Боеприпасы для фронта">
          <p>
            ...
            необходимо было переналадить оборудование и станки. На заводе
            создали отдел боеприпасов. В начале июля 1941 года бюро Сормовского
            райкома партии потребовало от предприятия «организовать
            круглосуточную работу на всех операциях, в двухдневный срок
            поставить и смонтировать недостающее оборудование, немедленно
            перевести работу цеха на полную мощность и обеспечить в оставшиеся
            дни выполнение плана июля месяца». Рабочие буквально жили в цехах,
            налаживая производство, выполняя и перевыполняя суточные задания.
          </p>
        ...
        <CommonImage>
          <figure className={classNames(styles.img, styles.main)}>
            ...
            <figcaption>
              «Красное Сормово» начало выпускать снаряды еще до Второй мировой
              войны
            </figcaption>
          </figure>
        </CommonImage>
        ...
        <CommonImage content>
          <figure className={classNames(styles.img, styles._1)}>
            ...
            <figcaption>Коллектив цеха по производству боеприпасов</figcaption>
          </figure>
        </CommonImage>
