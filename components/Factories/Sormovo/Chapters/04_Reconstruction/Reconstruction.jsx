    ...
    <div className={styles.root}>
      <div className={styles.page}>
        <MainText title="Перестройка производства">
          ...
          адаптированную версию авиационного мотора М-17, производство которого
          с началом войны наладили на Горьковском автозаводе. Детали для танков
          выпускали и другие нижегородские предприятия — «Красная Этна», ГАЗ,
          ЗАТИ, «Двигатель Революции», «Гудок Октября», Горьковский завод
          фрезерных станков и другие.
        </MainText>
        ...
        <CommonImages>
          <figure className={classNames(styles.img, styles.main)}>
            ...
            <figcaption>
              «Красное Сормово» обязали наладить выпуск танков в первые дни
              войны
            </figcaption>
          </figure>
          ...
          <figure className={classNames(styles.img, styles._2)}>
            ...
            <figcaption>Танк Т-34 разработали на харьковском заводе</figcaption>
          </figure>
        </CommonImages>
          ...
          left={
            <div>
              <figure className={classNames(styles.img, styles._3)}>
                ...
                <figcaption>
                  Приказ об организации выпуска Т-34 вышел 1 июля 1941 года
                </figcaption>
              </figure>
            </div>
          }
          right={
            <div>
              <p>
                ...
                производство началось в 1940 году. В 1941 году предполагалось,
                что производить Т-34 будут харьковский завод № 183 и
                Сталинградский тракторный завод. Однако с началом войны
                производство пришлось наладить на «Красном Сормове». Горьковчан
                направили в Харьков на обучение. Специалистов завода № 183
                командировали на «Красное Сормово», чтобы помочь наладить
                производство.
              </p>

              <p>
                Переориентация судостроительного завода на танкостроение шла
                сложно. Нужно было варить и катать сталь марки, которую раньше
                завод не производил. Усложнялась технология производства
                деталей, росло их количество. Кроме того, необходимо было
                изменить конструкцию танка Т-34 и приспособить ее под установку
                бензинового двигателя М-17. Чтобы организовать производство
                Т-34, завод начал реконструкцию: ввели более 26 тыс. кв. м
                производственных площадей и смонтировали около 600 станков.
              </p>
            </div>
          }
        />
        <CommonImage content>
          <figure className={classNames(styles.img, styles._1)}>
            ...
            <figcaption>
              На первые танки устанавливали авиамоторы М-17
            </figcaption>
          </figure>
        </CommonImage>
