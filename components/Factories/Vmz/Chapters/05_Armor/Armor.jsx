      ...
      <div className={styles.page}>
        <CommonImage>
          <figure className={classNames(styles.img, styles._1)}>
            ...
            <figcaption>
              Правка листа на ВМЗ производилась листобойными молотами
            </figcaption>
          </figure>
        </CommonImage>
        ...
        <Columns
          ...
          right={
            <div>
              ...
              автомобилей. Выксунский металлургический завод должен был столь же
              быстро наладить крупномасштабное производство броневых и других
              специализированных легированных сталей и обеспечить выпуск
              броневого листа разной толщины. Сроки для перестройки производства
              казались невыполнимо сжатыми. В красных уголках и в кабинетах
              руководителей появились койки — ­многие не выходили с завода по
              несколько суток. График работы диктовала фронтовая обстановка,
              поэтому выксунцам пришлось за кратчайшее время выполнить оборонный
              заказ.
            </div>
          }
        />
