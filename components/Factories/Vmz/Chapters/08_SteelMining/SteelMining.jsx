      ...
      <div className={styles.page}>
        <CommonText>
          <p>
            ...
            соединения серы. Горьковский комитет обороны сообщал, что
            использование древесного угля при карбюраторном процессе увеличивало
            массу закладки на 4–5%, что привело к удлинению периода закладки:
            «Так как уголь не полностью усваивается металлом, значительная часть
            его всплывает, создавая на поверхности металла слой изоляции, период
            плавления также значительно увеличивается. В результате этого
            длительность плавок на Выксунском заводе на рядовых марках
            увеличилась с 8 часов до 10–12 часов, на легированных марках с 12
            часов до 15–16 часов. Только от удлинения по времени плавок завод в
            среднем недодавал в месяц до 2 тыс. т стали». Чтобы обеспечить
            предприятие металлом, дирекция завода вынуждена была отправить
            техника завода С.Е. Куделькина лично к народному комиссару
