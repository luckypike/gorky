      ...
      <div className={styles.page}>
        <MainText title="Мастера огневых дел">
          <p>
            ...
            военный заказ. Выксунцы решили, что единственным выходом будет
            начать плавку брони в новомартеновском цехе в печах садкой 90 т. По
            технологии броневые стали плавили в электропечах, а не в
            большегрузных мартеновских, но условия военного времени не оставляли
            вариантов. Институт металлургии разработал секретную технологию, по
            которой спецстали начали изготавливать в мартенах. Ведущие инженеры
            завода обучали сталеваров варить броню по-новому. В результате
            напряженной работы план выпуска спецсталей за второе полугодие 1941
            года завод выполнил на 418,4%, труб — на 623,3%.
          </p>
        </MainText>
        ...
        <CommonImages>
          <figure className={classNames(styles.img, styles.main)}>
            ...
            <figcaption>Старый мартен. Плавка стали</figcaption>
          </figure>

          <figure className={classNames(styles.img, styles._4)}>
            <Image src="/images/vmz/6/4.jpg" layout="fill" />
            <figcaption>
              Мульды (стальные коробки для механизированной загрузки сырья в
              сталеплавильные печи) у старого мартеновского цеха
            </figcaption>
          </figure>
        </CommonImages>
      </div>
