    ...
    <div className={styles.root}>
      <div className={styles.page}>
        <MainText title="Модернизация в боевых условиях">
          ...
          пришлось провести модернизацию оборудования. За сутки цех давал до 300
          т броневого листа. В 1941 году заводской план по спецпрокату удалось
          выполнить на 626,5%. Броневые листы Выксунского металлургического
          завода шли на днище и заднюю часть корпуса Т-34, а также на легкие
          танки и СУ-76, броневики и бронепоезда. В 1944 году в цехе проводили
          капитальный ремонт. Чтобы обеспечить прокатку более толстых листов,
          удлинили пролет, стан №1 убрали совсем, у стана №2 усилили фундамент,
        ...
        <CommonImage>
          <figure className={classNames(styles.img, styles._1)}>
            ...
            <figcaption>
              В трубном цехе № 1 склад штрипса находился за пределами цеха,
              откуда штрипсы грузились вручную на тележках
            </figcaption>
          </figure>
        </CommonImage>
        ...
        <CommonImage content>
          <figure className={classNames(styles.img, styles.main)}>
            ...
            <figcaption>
              Подача болванки электрокошкой на платформу листопрокатного стана
            </figcaption>
          </figure>
        </CommonImage>
        ...
        <CommonImage content>
          <figure className={classNames(styles.img, styles._3)}>
            ...
            <figcaption>Термическая печь листопрокатного цеха</figcaption>
          </figure>
        </CommonImage>
        ...
        <CommonImage content>
          <figure className={classNames(styles.img, styles._2)}>
            ...
            <figcaption>Правильная машина листопрокатного цеха</figcaption>
          </figure>
        </CommonImage>
      </div>
    </div>
