    ...
    <div className={styles.root}>
      <div className={styles.page}>
        <MainText title="Фонд обороны">
          <p>
            В победу выксунцы вкладывались не только трудом, но и деньгами. К
            сентябрю 1942 года они внесли во Всесоюзный фонд обороны 2,89 млн
        ...
        <CommonImage>
          <figure className={classNames(styles.img, styles._2)}>
            ...
            <figcaption>Танк колонны «Выксунский металлург» в бою</figcaption>
          </figure>
        </CommonImage>
