    ...
    <div className={styles.root}>
      <div className={styles.page}>
        ...
        >
          ...
          „горнушками“. Для отопления сжигали кокс и все деревянные постройки,
          в том числе и полы. Окна были закрашены для маскировки краской, так
          как вечером в 10 часов пролетали фашистские самолеты на Горький и
          бомбили все заводы. В цехе было очень много дыма и чада от
          „горнушек“. Умыться можно было только холодной водой. Туалеты были
          только на улице».
        </Speech>
      </div>
    </div>
