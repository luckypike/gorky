      ...
      <div className={styles.page}>
        ...
        <CommonImage>
          <figure className={classNames(styles.img, styles.main)}>
            ...
            <figcaption>
              Кроме фронтовой продукции в годы войны завод „Красная Этна“
              продолжал выпускать крепеж, проволоку, ленту холодного проката
            </figcaption>
          </figure>
        </CommonImage>
          ...
          right={
            <div>
              <p>
                ...
                Запорожья и Белоруссии — чуть больше сотни. В сумме — около 8%
                от численности персонала «Красной Этны».
              </p>
              ...
              <p>
                ...
                было бы невозможным. Проблема рабочих кадров решалась за счет
                домохозяек, жен красноармейцев, подростков. На производстве были
                организованы школы техобучения для новичков. Так, осенью 1941
                года на заседании парткома завода начальник отдела кадров
                Гордеев докладывал, что в цехе №4 была организована такая школа
                для 37 домохозяек, которые после обучения стали выполнять
                производственные нормы на 240%.
              </p>
              <p>
                ...
                рабочих. 28 октября 1944 года завод был награжден орденом Ленина
                за самоотверженный труд в годы Великой Отечественной войны и
                бесперебойное снабжение фронта боеприпасами. ­Более 3 тыс.
                сотрудников предприятия награждены орденами и медалями, в том
                числе директор А. И. Романов был удостоен орденов Ленина и
                Трудового Красного Знамени, главный инженер И. Ф. Синицын —
                орденов Трудового Красного Знамени и Красной Звезды.
              </p>
            </div>
          }
        />
