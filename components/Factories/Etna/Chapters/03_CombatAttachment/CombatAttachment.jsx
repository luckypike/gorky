      ...
      <div className={styles.page}>
        <MainImage>
          <figure className={classNames(styles.img, styles.intro)}>
            ...
            <figcaption>
              Во время Первой мировой войны рижский завод «Этна» был эвакуирован
              в Нижний Новгород и здесь отстроен заново
            </figcaption>
          </figure>
        </MainImage>
        ...
        <MainText title="Боевое крепление">
          <p>
            ...
            году в Риге В.М. Гольденбергом и П. И. Мартини. В 1915 году, во
            время Первой мировой войны, предприятие эвакуировали в Нижний
            Новгород, где год спустя его выкупил торговый дом «А.Б. Фрадкин и
            сын». После национализации в 1922 году в честь пятилетия советской
            власти завод был переименован в «Красную Этну». В 1933 году на
            предприятии началось производство нормалей для только что
        ...
        <CommonImage>
          <figure className={classNames(styles.img, styles._1)}>
            ...
            <figcaption>
              Шурупное производство — одна из многочисленных специализаций
              «Красной Этны» по автонормалям
            </figcaption>
          </figure>
        </CommonImage>
        ...
        <CommonText>
          <p>
            Несколько лет завод «Красная Этна» был филиалом ГАЗа, а в 1938 году
            ему вернули самостоятельность — предприятие начало выпускать
            продукцию для всего автопрома страны.
          </p>
