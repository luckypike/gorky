...
export { default as NextFactory } from './NextFactory/NextFactory'
export { default as Gallery } from './Gallery/Gallery'
export { default as Header } from './Header/Header'
export { default as MainImage } from './MainImage/MainImage'
export { default as CommonImages } from './CommonImages/CommonImages'
...
export { default as VictoryTechnique } from './VictoryTechnique/VictoryTechnique'
