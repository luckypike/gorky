  ...
  return (
    <div className={styles.root}>
      ...
      <CommonText>
        ...
        Ефима Рубинчика — Александр Рубинчик. <br />С сентября по декабрь 1941
        года завод передал фронту 173 танка. Чтобы снизить зависимость от
        ...
        числе в 1942 году предприятие стало выпускать траки — звенья гусеничной
        ленты, тем самым освободив от этой нагрузки Горьковский автозавод.
      </CommonText>
      <div>
        <Speech
      ...
      <CommonText>
        ...
        стал сдавать в среднем по десять машин в день. <br /> Достичь этого
        удалось благодаря самоотверженному труду рабочих. Знания передавались от
        мастера к ученикам, ветераны обучали новых специалистов прямо на
        производстве. Только за 1942 год они подготовили около 7,5 тыс. молодых
        сотрудников — токарей, формовщиков, слесарей и сталеваров.
      </CommonText>
      <div>
        <Speech
