...
const Women = () => {
  return (
    <div className={styles.root}>
      ...
      <CommonText>
        «Мы, старики, не должны сидеть дома. В грозный и ответственный момент у
        нас еще хватит сил по-боевому работать для своей Родины»,— обратился к
        коллегам ветеран труда И. М. Олимпиев. В первый же год на завод
        ...
        усовершенствовать технологии и методы работы.
      </CommonText>
      {/* <Gallery image={main}/> */}
      <div>
        <Speech
      ...
      <CommonText>
        На заводе развернулось движение рационализаторов и изобретателей.
        Рабочие соревновались в увеличении темпов производства. Состязания
        устраивали как между отдельными мастерами, так и между целыми цехами.
        Результаты подводили во Дворце культуры. Победителям вручали переходящее
