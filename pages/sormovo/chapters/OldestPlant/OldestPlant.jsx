  ...
  return (
    <div className={styles.root}>
      ...
      <CommonText>
        ...
        для обороны Севастополя. <br />В начале ХХ века сормовичи спускали на
        воду канонерские лодки для реки Амур, построили мощную паровую машину
        для крейсера «Очаков». Крупные военные заказы предприятие стало получать
        с 1914 года. К этому времени завод произвел свыше 2 тыс. паровозов, 60
        тыс. единиц подвижного состава и другой продукции тяжелого
        машиностроения. Накануне Первой мировой войны завод освоил производство
        бомб и снарядов. Постепенно сормовичи стали выпускать пушки, повозки для
        ружейных стволов, бронированные зарядные ящики, фугасные снаряды,
        шрапнели, бомбы, патронные двуколки. В те годы на предприятии главным
        стало производство военного снаряжения и вооружения, судостроение почти
